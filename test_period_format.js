...
// Test the new number formatting with period after number
...
class NumberFormatTester {
  ...
  formatNumberWithUnit(num, unit = 'USDT') {
    ...
    // Always ensure USDT is added for consistency with period after the number
...
console.log("=== ĐỊNH DẠNG SỐ MỚI (có dấu chấm sau số) ===\n");
